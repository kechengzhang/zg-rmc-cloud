...
import com.zgtec.zgrmc.domain.Oauth2TokenDto;
...
public class AuthController {
    ...
    public Result<Oauth2TokenDto> postAccessToken(HttpServletRequest request,
        ...
        return Result.success(ResultCodeEnum.TOKEN_SUCCESS,oauth2TokenDto);
    }
}
